...
function Footer() {
    return (
      ...
      <footer className="flex flex-col mx-14 border-t-2 bg-transparent text-slate-100 border-gray-300 dark:bg-transparent">
        <div className="mx-auto my-4 text-lg">copy right @rclavanya</div>
      </footer>
      // <footer className="bg-white w-full shadow  dark:bg-gray-800 flex justify-end">
